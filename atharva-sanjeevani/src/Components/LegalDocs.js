  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Atharva Sanjeevani <span className="legal-siteSign">+</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Atharva Sanjeevani, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Atharva Sanjeevani, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Atharva Sanjeevani is designed to simplify healthcare access. You can choose
      ...
      <div className="legal-footer">
        <p>© 2024 Atharva Sanjeevani. All rights reserved.</p>
      </div>
    </div>
  );
}
